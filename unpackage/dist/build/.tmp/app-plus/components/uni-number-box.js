(global["webpackJsonp"] = global["webpackJsonp"] || []).push([["components/uni-number-box"], {
    "052a": function (t, e, i) {
        ...
        var a = {
            ...
            data: function () {
                return {inputValue: this.value, minDisabled: !1, maxDisabled: !1}
            },
            created: function () {
            ...
            watch: {
                inputValue: function (t) {
                    var e = {number: t, index: this.index};
                    this.$emit("eventChange", e)
                }
            },
            methods: {
                _calcValue: function (t) {
                    var e = this._getDecimalScale(), i = this.inputValue * e, a = 0, n = this.step * e;
        ...
        i("9305");
        var s = i("2877"), l = Object(s["a"])(n["default"], a["a"], a["b"], !1, null, null, null);
        e["default"] = l.exports
    }, "8ba9": function (t, e, i) {
        "use strict";
        var a = function () {
        ...
        "use strict";
        var a = i("8cef"), n = i.n(a);
        n.a
    }, c9d9: function (t, e, i) {
        "use strict";
        i.r(e);
        var a = i("052a"), n = i.n(a);
